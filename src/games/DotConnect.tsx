...
const PATTERNS: DotPattern[] = [
  ...
  { name: 'つき',     emoji: '🌙', close: true,   // 8点（追加）みかづき
    dots: [{ x:205,y:45 },{ x:140,y:60 },{ x:90,y:110 },{ x:75,y:170 },{ x:100,y:225 },{ x:160,y:260 },{ x:215,y:255 },{ x:165,y:225 },{ x:130,y:180 },{ x:128,y:125 },{ x:155,y:80 }] },
  { name: 'くるま',   emoji: '🚗', close: true,   // 8点（追加）よこむきのくるま
    dots: [{ x:30,y:205 },{ x:30,y:160 },{ x:85,y:150 },{ x:115,y:95 },{ x:200,y:95 },{ x:235,y:150 },{ x:280,y:160 },{ x:280,y:205 },{ x:225,y:205 },{ x:225,y:235 },{ x:170,y:235 },{ x:170,y:205 },{ x:110,y:205 },{ x:110,y:235 },{ x:55,y:235 },{ x:55,y:205 }] },
  { name: 'ねこ',     emoji: '🐱', close: true,   // 8点（追加）みみつきのかお
    dots: [{ x:70,y:120 },{ x:70,y:45 },{ x:120,y:80 },{ x:180,y:80 },{ x:230,y:45 },{ x:230,y:120 },{ x:250,y:165 },{ x:215,y:225 },{ x:150,y:245 },{ x:85,y:225 },{ x:50,y:165 }] },
  { name: 'はな',     emoji: '🌷', close: true,   // 8点（追加）チューリップ
    dots: [{ x:150,y:60 },{ x:195,y:95 },{ x:215,y:70 },{ x:230,y:130 },{ x:215,y:210 },{ x:150,y:245 },{ x:85,y:210 },{ x:70,y:130 },{ x:85,y:70 },{ x:105,y:95 }] },
    { name: 'アイス',   emoji: '🍦', close: true,   // 9点 ※とり(2026-08-02 差替)＝一筆書きの輪郭では鳥に見えず、コーン+まるいアイスの形へ変更
    dots: [{ x:150,y:270 },{ x:196,y:152 },{ x:202,y:118 },{ x:182,y:86 },{ x:150,y:70 },{ x:118,y:86 },{ x:98,y:118 },{ x:104,y:152 }] },
  ...
  { name: 'でんしゃ', emoji: '🚃', close: true,   // 10点 ※前方スロープ＋細いえんとつ＋高い運転室で機関車らしさを明確化
    dots: [{ x:100,y:95 },{ x:100,y:55 },{ x:140,y:55 },{ x:140,y:95 },{ x:265,y:95 },{ x:265,y:215 },{ x:230,y:215 },{ x:230,y:245 },{ x:185,y:245 },{ x:185,y:215 },{ x:115,y:215 },{ x:115,y:245 },{ x:70,y:245 },{ x:70,y:215 },{ x:35,y:215 },{ x:35,y:130 }] },
