...
const GAMES = [
  ...
  },
  {
    ...
    title: 'もじならべ | でんしゃあそび',
    name: 'もじならべ',
    desc: 'バラバラのひらがなを並び替えて言葉を作ろう。どうぶつ・たべもの・のりもの・みのまわりの4カテゴリ122語。絵とひらがなのせつめい付きで安心。タイムアタックも。',
    keywords: 'ひらがな 並び替え 言葉 アナグラム 小学生 国語 電車 ゲーム',
    age: '5さい〜9さい',
    aim: 'バラバラに なった ひらがなを ならびかえて ことばを つくる ゲームです。',
    howto: 'えと ひらがなの せつめいが でてきます。もじを タップして ただしい じゅんばんに ならべてね。どうぶつ・たべもの・のりもの・みのまわり の 4つの カテゴリから えらべます。タイムアタックで なんもん とけるか チャレンジしよう。',
  ...
  },
  {
    ...
    name: 'ひらがなさがし',
    desc: '6×6のひらがなグリッドから隠れた言葉を探そう！どうぶつ・たべもの・がっこう・しぜん など20パズル。ワードサーチゲーム。',
    keywords: 'ひらがな 言葉探し ワードサーチ 国語 小学生 幼稚園 電車 ゲーム',
    age: '6さい〜9さい',
    aim: '6×6の ひらがなの ますから、かくれた ことばを みつけだす ワードサーチゲームです。',
    howto: 'した（または よこ）に かかれた ことばを、ますの なかから さがします。さいしょの もじと さいごの もじを タップしてね。どうぶつ・たべもの・がっこう・しぜん など 20パズルが あって、クリアした パズルには チェックが つきます。',
  ...
  },
  {
    ...
    name: 'ドットつなぎ',
    desc: '番号順に点をつないで絵を完成させよう！3点のさんかくから16点のたいようまで難易度順に20パターン。完成した絵にはチェックがつくよ。',
    keywords: '点つなぎ ドット 絵 完成 幼稚園 小学生 電車 ゲーム パズル',
    age: '4さい〜9さい',
    aim: 'すうじが ふられた てんを 1から じゅんに つないで えを かんせいさせる ゲームです。',
    howto: '1の てんから タップを はじめて、2・3・4…と じゅんばんに つないでね。3てんの さんかくから 16てんの たいようまで、むずかしさが だんだん あがる 20パターンが あります。かんせいした えには チェックが つくよ。なにが できるかは、つないでみての おたのしみ！',
  ...
  },
  {
    ...
    title: 'なぞなぞ | でんしゃあそび',
    name: 'なぞなぞ',
    desc: 'やさしい〜むずかしいの50問のなぞなぞ。ヒント付きで4歳から遊べる。親子で考えて盛り上がろう！答えはタップで表示。',
    keywords: 'なぞなぞ 子供 クイズ ヒント 幼児 小学生 親子 電車 暇つぶし',
    age: '4さい〜9さい',
    aim: 'ヒントを たよりに こたえを かんがえる なぞなぞが 50もん あります。',
    howto: 'もんだいを よんで、こたえを かんがえてね。わからない ときは「ヒントをみる」を タップ。こたえは「こたえを みる」で ひょうじされます。やさしい・ふつう・むずかしいの 3だんかいから えらべるよ。',
    effect: 'ことばあそびや とんちを つうじて、ことばの ちからと やわらかい はっそうりょくを そだてます。おやこの かいわも はずみます。',
  },
  {
    path: 'simon',
    emoji: '🌈',
...
<div class="static-fallback">
  ...
  <main class="wrap">
    <section class="intro">
      <h2>このサイトについて</h2>
      <p>「でんしゃあそび」は、でんしゃや くるまの なかで こどもが あそべる ミニゲームを 13しゅるい あつめた サイトです。たいしょうは ようちえん〜小がっこう3年生（4〜9さい）。すべての ゲームは ブラウザだけで うごき、アプリの ダウンロードや かいいんとうろくは いりません。</p>
      <ul>
    ...
    <h2 class="section">🎮 ゲーム いちらん（13しゅるい）</h2>
...
<div class="static-fallback">
  ...
  <main class="wrap">
    ...
    <section class="intro">
      <h2>なんのための サイト？</h2>
      <p>「でんしゃあそび」は、でんしゃや くるまの なかで こどもが たいくつ しないように と かんがえて つくった ミニゲームの しゅうごうサイトです。みじかい じかんで あそべる ゲームを 13しゅるい よういして います。</p>
    </section>
